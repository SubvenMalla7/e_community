(function ($) {
	...
	$('body').on('click', function (e) {
		...
		if (!$($target).is('.message-dropdown') && !$($target).parents().is('.message-dropdown')) {
			$(".message-dropdown").addClass('hidebox');
		}
	});
	$('body').on('click', function (e) {
		var $target = e.target;
		if (!$($target).is('.notification-dropdown') && !$($target).parents().is('.notification-dropdown')) {
			$(".notification-dropdown").addClass('hidebox');
		}
	});
	$('body').on('click', function (e) {
		var $target = e.target;
		if (!$($target).is('.calender-dropdown ') && !$($target).parents().is('.calender-dropdown ')) {
			$(".calender-dropdown ").addClass('hidebox');
		}
	});
	$('body').on('click', function (e) {
		var $target = e.target;
		if (!$($target).is('.search-dropdown') && !$($target).parents().is('.search-dropdown')) {
			$(".search-dropdown").addClass('hidebox');
		}
	});
